    ...
    public static class DataSeeder
    {
        public static async Task SeedAsync(LeagueDbContext context)
        {
            ...
            var sponsors = new List<Sponsor>
            {
                ...
                {
                    Name = "BetPlay",
                    ContactEmail = "contacto@betplay.com.co",
                    Phone = "+57 3000000001",
                    WebsiteUrl = "https://betplay.com.co",
                    Category = SponsorCategory.Main
                },
                new()
                {
                    Name = "Adidas Colombia",
                    ContactEmail = "marketing@adidas.com.co",
                    Phone = "+57 3000000002",
                    WebsiteUrl = "https://www.adidas.co",
                    Category = SponsorCategory.Gold
                },
                new()
                {
                    Name = "Coca-Cola",
                    ContactEmail = "sports@coca-cola.com",
                    Phone = "+57 3000000003",
                    WebsiteUrl = "https://www.coca-cola.com/co/es",
                    Category = SponsorCategory.Gold
                },
                new()
                {
                    Name = "Águila",
                    ContactEmail = "patrocinios@aguila.com.co",
                    Phone = "+57 3000000004",
                    WebsiteUrl = "https://www.aguila.com.co",
                    Category = SponsorCategory.Silver
                },
                new()
                {
                    Name = "Movistar",
                    ContactEmail = "alianzas@movistar.co",
                    Phone = "+57 3000000005",
                ...
                {
                    Name = "Gatorade",
                    ContactEmail = "sports@gatorade.com",
                    Phone = "+57 3000000006",
                    WebsiteUrl = "https://www.gatorade.com",
                    Category = SponsorCategory.Bronze
                }
            };
